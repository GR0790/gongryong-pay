...
export const blogPostsData = [
  {
    ...
    excerpt: "소액결제 현금화로 급한 불은 껐지만, 다음 달 청구서가 걱정되시나요? 연체를 막고 신용점수를 지키는 스마트한 요금 관리 방법부터, 만약의 상황을 대비한 해결책까지 공룡페이가 알려드립니다.",
    category: "한도관리",
    readTime: "9분",
    image: "🧾",
...
export const blogContentData: { [key: string]: any } = {
    "14": {
      content: `
        ...
        <h3>결론: 공룡페이는 여러분의 건강한 금융 생활을 응원합니다</h3>
        <p>공룡페이는 단순히 현금을 마련해드리는 것을 넘어, 고객님들이 건강한 금융 생활을 유지하실 수 있도록 돕고자 합니다. 소액결제 이용 후 상환 계획에 어려움이 있거나 궁금한 점이 있다면, 언제든지 저희 <a href="/contact" class="text-green-600 hover:underline font-semibold">24시간 상담센터</a>에 문의해주세요. 함께 해결책을 찾아드리겠습니다.</p>
      `,
    },
    "13": {
      content: `
    ...
    "9": {
        ...
        <p>가장 기본적이면서도 중요한 단계입니다. 웹사이트 하단에 <strong>사업자등록번호, 상호명, 대표자명</strong>이 명확하게 기재되어 있는지 확인하세요. 저희 <a href="/safety" class="text-green-600 hover:underline font-semibold">공룡페이</a>는 모든 정보를 투명하게 공개하는 정식 등록 업체입니다.</p>
        ...
        <p>실제 이용자들이 남긴 후기는 업체의 신뢰도를 판단하는 좋은 기준이 됩니다. 특히 입금 시간, 상담원의 친절도, 수수료 만족도 등을 중점적으로 살펴보세요. <a href="/reviews" class="text-green-600 hover:underline font-semibold">공룡페이 고객 후기</a> 페이지에서 실제 이용자들의 솔직한 경험담을 확인하실 수 있습니다.</p>
