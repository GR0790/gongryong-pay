          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-1 w-48 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-10" role="menu" aria-label="서비스 소개 하위 메뉴">
                  <Link to="/services/micropayment" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-inset" role="menuitem">소액결제 현금화</Link>
                  <Link to="/services/information-fee" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-inset" role="menuitem">정보이용료 현금화</Link>
                  <Link to="/services/credit-card" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-inset" role="menuitem">신용카드 현금화</Link>
                  <Link to="/services/gift-card" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-inset" role="menuitem">상품권 현금화</Link>
                </div>
              </div>
      ...
      <footer className="bg-gray-900 text-white py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm md:text-base">
                <li><Link to="/services/micropayment" className="hover:text-white transition-colors">소액결제 현금화</Link></li>
                <li><Link to="/services/information-fee" className="hover:text-white transition-colors">정보이용료 현금화</Link></li>
                <li><Link to="/services/credit-card" className="hover:text-white transition-colors">신용카드 현금화</Link></li>
                <li><Link to="/services/gift-card" className="hover:text-white transition-colors">상품권 현금화</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm md:text-base">
                <li><Link to="/how-to-use" className="hover:text-white transition-colors">이용 방법</Link></li>
                <li><Link to="/faq" className="hover:text-white transition-colors">자주 묻는 질문 (FAQ)</Link></li>
                <li><Link to="/safety" className="hover:text-white transition-colors">안전 거래 안내</Link></li>
                <li><Link to="/blog" className="hover:text-white transition-colors">유용한 정보 블로그</Link></li>
                <li><Link to="/contact" className="hover:text-white transition-colors">24시 고객센터 문의</Link></li>
          ...
          <div className="border-t border-gray-800 mt-8 md:mt-12 pt-6 md:pt-8 text-center text-gray-400">
            <p className="text-sm md:text-base">© 2025 공룡페이 (GongryongPay). 모든 권리 보유.</p>
