...
const HowToUse: React.FC = () => {
    ...
    micropayment: {
      ...
      steps: [
        ...
        },
        {
          step: 2,
          title: '본인 인증 및 결제 진행',
          description: '간단한 본인 인증 후 소액결제를 통한 상품 구매가 진행됩니다.',
          details: [
            '휴대폰 본인 인증 (SMS 등)',
            '소액결제 비밀번호 입력',
            '상품 구매 완료 확인',
        ...
        },
        {
          step: 3,
          title: '현금 입금 완료',
          description: '결제 확인 후 약정된 지급률에 따라 즉시 계좌로 입금됩니다.',
          details: [
            '계좌번호 확인 및 입금 처리',
            '입금 완료 문자 발송',
            '거래 완료 확인',
      ...
      steps: [
        {
          step: 1,
          title: '정보이용료 한도 확인',
          description: '통신사별 정보이용료 한도를 확인하고 이용 가능 금액을 체크합니다.',
          details: [
        ...
        },
        {
          step: 2,
          title: '정보서비스 이용 및 인증',
          description: '정보이용료가 부과되는 서비스를 이용하고 본인 인증을 진행합니다.',
          details: [
            '통신사 본인 인증 진행',
            '정보이용료 결제 동의',
            '서비스 이용 완료',
        ...
        },
        {
          step: 3,
          title: '현금 지급 및 완료',
          description: '정보이용료 결제 확인 후 지급률에 따른 현금이 입금됩니다.',
          details: [
            '결제 확인 및 검증',
            '지급률 적용하여 현금 계산',
            '고객 계좌로 즉시 입금',
      ...
      steps: [
        {
          step: 1,
          title: '카드 정보 확인 및 상담',
          description: '보유하신 신용카드 정보를 확인하고 이용 가능 한도를 체크합니다.',
          details: [
            '신용카드 종류 및 브랜드 확인',
            '현재 이용 가능 한도 확인',
            '희망 현금화 금액 상담',
        ...
        },
        {
          step: 2,
          title: '결제 진행 및 본인 확인',
          description: '신용카드로 상품을 구매하고 본인 확인 절차를 진행합니다.',
          details: [
      ...
      steps: [
        {
          ...
          description: '보유하신 상품권의 종류와 금액을 확인하고 지급률을 안내받습니다.',
          details: [
      ...
      steps: [
        {
          step: 1,
          title: '플랫폼 및 한도 확인',
          description: '이용하실 앱스토어 플랫폼과 결제 가능 한도를 확인합니다.',
          details: [
        ...
        },
        {
          step: 2,
          title: '콘텐츠 구매 및 인증',
          description: '지정된 앱이나 게임에서 아이템을 구매하고 본인 인증을 진행합니다.',
          details: [
            '앱스토어 로그인 및 인증',
            '게임 아이템 또는 앱 구매',
            '휴대폰 본인 인증',
        ...
        },
        {
          step: 3,
          title: '현금 지급 및 완료',
          description: '콘텐츠 구매 확인 후 지급률에 따른 현금이 계좌로 입금됩니다.',
          details: [
            '구매 내역 확인 및 검증',
            '플랫폼별 지급률 적용',
            '계좌 입금 처리',
  ...
  const activeGuide = serviceGuides[activeService as keyof typeof serviceGuides];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-green-50 to-green-100 py-12 md:py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            처음 이용하시는 분들도 쉽게 따라할 수 있도록 단계별로 상세하게 안내해드립니다.
            각 서비스별 이용 방법과 주의사항을 꼼꼼히 확인하세요.
          </p>
      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">이용 방법을 확인할 서비스를 선택하세요</h2>
          <div className="flex flex-wrap justify-center gap-4">
        ...
        <section className="mb-16">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">{activeGuide.title}</h2>
                  ...
                  <div className="flex items-start space-x-6">
                    ...
                    <div className="flex-grow">
                      ...
                      <div className="bg-gray-50 rounded-lg p-4">
                        <h4 className="font-semibold text-gray-900 mb-2">세부 절차:</h4>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
              ...
              <ul className="space-y-2">
                {activeGuide.precautions.map((precaution, index) => (
                  <li key={precaution} className="flex items-start text-yellow-800">
        ...
        {/* General Tips */}
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">💡 현금화 서비스 이용 꿀팁</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl">🕐</span>
              </div>
              <h3 className="font-bold text-gray-900 mb-2 text-center">최적 이용 시간</h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <h3 className="font-bold text-gray-900 mb-2 text-center">지급률 최적화</h3>
              <p className="text-gray-600 text-sm text-center">
                여러 서비스를 조합하여 이용하시면 더 높은 지급률을 받을 수 있습니다.
                상담 시 최적 조합을 안내해드립니다.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <h3 className="font-bold text-gray-900 mb-2 text-center">안전한 거래</h3>
              <p className="text-gray-600 text-sm text-center">
                본인 인증은 필수이며, 타인 명의 이용은 절대 불가합니다.
                안전한 거래를 위해 정확한 정보를 제공해주세요.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          <div className="bg-red-50 border border-red-200 rounded-2xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-bold text-red-800 mb-4">결제 후 입금이 안 될 때</h3>
              ...
              <div>
                <h3 className="text-xl font-bold text-red-800 mb-4">의심스러운 업체 만났을 때</h3>
                <ul className="space-y-2 text-red-700">
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-red-600 rounded-full mr-3 mt-2 flex-shrink-0" />
                    선입금 요구 시 즉시 거래 중단
        ...
        <section>
          <div className="bg-gradient-to-r from-green-600 to-blue-600 rounded-2xl p-8 md:p-12 text-white text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">🎯 아직도 궁금한 점이 있으신가요?</h2>
            <p className="text-lg md:text-xl mb-8 opacity-90">
              전문 상담사가 24시간 대기중입니다. 1:1 맞춤 상담으로 더 자세한 이용 방법을 안내해드려요!
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                to="/contact"
