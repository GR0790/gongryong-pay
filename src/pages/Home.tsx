          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            ...
            <div className="flex-1 text-center">
              ...
              <p className="text-sm text-gray-500 mt-4">
                정식 사업자 등록 업체 공룡페이, 소액결제현금화 100% 안전거래
                보장!
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            ...
            >
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4 text-sm md:text-base">
                  ...
                  <strong className="text-blue-600">지급률 60~70%</strong>,
                  빠르고 안전한 입금을 보장합니다.
                </p>
                <span className="text-green-600 font-semibold hover:text-green-700 transition-colors">
                  정보이용료 방법 보기 →
            ...
            >
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4 text-sm md:text-base">
                  신용카드 한도를 활용한 비상금 마련!{" "}
                  <strong className="text-purple-600">지급률 82~88%</strong>,
                  정식 등록 업체에서 안전하고 빠르게 진행됩니다.
                </p>
                <span className="text-green-600 font-semibold hover:text-green-700 transition-colors">
                  신용카드 방법 보기 →
                </span>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-gray-50 rounded-2xl p-6 hover:bg-gray-100 transition-colors">
              ...
              <p className="text-gray-700 text-sm md:text-base">
                "신용카드현금화 절차가 복잡할 줄 알았는데 공룡페이는 생각보다
                간편하고 안전하게 처리해주셔서 감사합니다. 믿고 맡길 수
                있겠어요."
              </p>
            </div>
          </div>
