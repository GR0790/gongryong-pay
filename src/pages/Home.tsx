  ...
  return (
    <>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            ...
            <div className="flex-1 text-center">
              ...
              <p className="text-lg md:text-xl text-gray-700 mb-8 max-w-3xl mx-auto leading-relaxed">
                ...
                <span className="text-red-600 font-bold">소액결제현금화 미납/정책 99.9% 승인, 5분이면 거래완료!</span>
              </p>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 mb-8 max-w-lg mx-auto border-2 border-green-200">
                <div className="text-center">
                  <div className="text-sm text-red-600 font-bold mb-3">🔥 소액결제현금화 실시간 거래 현황 (LIVE)</div>
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      <div className="text-xl font-bold text-green-600">1,247건</div>
                  ...
                  <div className="text-xs text-gray-400 mt-3 border-t pt-2">
                    ⚡ 평균 2분 47초 입금완료 | 💯 고객만족도 99.9% | 🏆 월 거래량 3만건+
                  </div>
                </div>
              </div>
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">공룡페이 소액결제현금화 핵심 서비스 안내</h2>
            <p className="text-lg md:text-xl text-gray-600 max-w-4xl mx-auto">2025년 업계 최고 지급률! 소액결제현금화, 정보이용료현금화, 신용카드현금화, 상품권현금화 서비스를 빠르고 안전하게 제공합니다.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            ...
            <Link to="/services/micropayment" className="bg-white rounded-2xl border border-gray-200 p-6 hover:shadow-xl hover:border-green-200 transition-all duration-300 hover:-translate-y-1 block">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4 text-sm md:text-base">휴대폰 소액결제 한도 즉시 현금으로! 평균 3분 이내, <strong className="text-green-600">지급률 70~80%</strong>로 신속하게 비상금을 마련하세요.</p>
                <span className="text-green-600 font-semibold hover:text-green-700 transition-colors">소액결제현금화 방법 보기 →</span>
              </div>
            </Link>
            ...
            <Link to="/services/information-fee" className="bg-white rounded-2xl border border-gray-200 p-6 hover:shadow-xl hover:border-green-200 transition-all duration-300 hover:-translate-y-1 block">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4 text-sm md:text-base">구글 정보이용료(콘텐츠이용료) 등 남은 한도를 현금으로! <strong className="text-blue-600">지급률 60~70%</strong>, 빠르고 안전한 입금을 보장합니다.</p>
            ...
            <Link to="/services/credit-card" className="bg-white rounded-2xl border border-gray-200 p-6 hover:shadow-xl hover:border-green-200 transition-all duration-300 hover:-translate-y-1 block">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4 text-sm md:text-base">신용카드 한도를 활용한 비상금 마련! <strong className="text-purple-600">지급률 82~88%</strong>, 정식 등록 업체에서 안전하고 빠르게 진행됩니다.</p>
            ...
            <Link to="/services/gift-card" className="bg-white rounded-2xl border border-gray-200 p-6 hover:shadow-xl hover:border-green-200 transition-all duration-300 hover:-translate-y-1 block">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4 text-sm md:text-base">모바일 문화상품권, 해피머니 등 각종 상품권을 <strong className="text-orange-600">지급률 75~85%</strong>로 신속하게 현금으로 교환해 드립니다.</p>
      ...
      <section className="py-12 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">왜 공룡페이 소액결제현금화일까요? 소액결제현금화 업계 1위!</h2>
            <p className="text-lg md:text-xl text-gray-600 max-w-4xl mx-auto">풍부한 거래실적과 고객 만족도 99.9%로 증명된 신뢰! 소액결제현금화, 정보이용료현금화, 신용카드현금화, 상품권현금화 모든 서비스에서 업계 최고를 자부합니다.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">미납·정책 99.9% 승인</h3>
              <p className="text-gray-600">다른 업체에서 거절당했나요? 공룡페이는 <strong className="text-red-600">미납·정책 99.9% 승인</strong>! 포기하지 마시고 상담받아보세요.</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600">신청부터 입금까지 평균 3분! 기다림 없이 신속하게 현금화 문제를 해결하세요. <strong className="text-green-600">5분이면 거래완료</strong></p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">투명한 지급률 시스템</h3>
              <p className="text-gray-600">정직하고 투명한 수수료 정책! 소액결제현금화 <strong className="text-blue-600">70~80%</strong>, 정보이용료 60~70%, 신용카드 82~88% 투명한 지급률!</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">풍부한 거래실적</h3>
              <p className="text-gray-600"><strong className="text-purple-600">안정적인 거래규모 달성</strong>! 정식 사업자 등록으로 100% 안전거래를 보장합니다.</p>
            </div>
          </div>
          ...
          <div className="mt-16">
            <div className="bg-white rounded-3xl shadow-xl p-8">
              <h3 className="text-2xl font-bold text-center text-gray-900 mb-8">📊 공룡페이 실시간 통계</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div className="text-center">
                  <div className="text-3xl font-bold text-blue-600 mb-2">3만건+</div>
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-red-600 mb-2">2분 47초</div>
                  <div className="text-sm text-gray-600">평균 입금시간</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-purple-600 mb-2">24시간</div>
                  <div className="text-sm text-gray-600">연중무휴 상담</div>
                </div>
              </div>
              <div className="text-center mt-6">
                <p className="text-gray-500 text-sm">📈 실시간 업데이트 | ✅ 정식 사업자 등록 업체 | 🏅 신뢰할 수 있는 공룡페이</p>
              </div>
            </div>
          </div>
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-4xl mx-auto">공룡페이를 통해 소액결제현금화, 정보이용료현금화, 신용카드현금화, 상품권현금화 서비스를 경험한 고객님들의 솔직한 목소리입니다.</p>
          </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 hover:bg-gray-100 transition-colors">
              <div className="mb-4">
                <div className="flex items-center mb-2">
                  ...
                  <span className="font-bold text-gray-900 text-sm md:text-base">김*석 고객님 (소액결제현금화)</span>
                </div>
              ...
              <p className="text-gray-700 text-sm md:text-base">"정말 급했는데 3분도 안되서 입금됐어요! 상담도 친절하시고 소액결제현금화 최고입니다. 공룡페이 덕분에 잘 해결했어요."</p>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 hover:bg-gray-100 transition-colors">
              <div className="mb-4">
                <div className="flex items-center mb-2">
                  ...
                  <span className="font-bold text-gray-900 text-sm md:text-base">이*희 고객님 (정보이용료현금화)</span>
                </div>
                <div className="flex items-center">
                  <div className="flex text-yellow-400">
                    <span className="text-lg md:text-xl">⭐</span>
              ...
              <p className="text-gray-700 text-sm md:text-base">"타업체보다 정보이용료현금화 수수료도 저렴하고 입금도 빨라서 좋았어요. 다음에도 이용할게요! 안전한 공룡페이 찾아서 다행이에요."</p>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 hover:bg-gray-100 transition-colors">
              <div className="mb-4">
                <div className="flex items-center mb-2">
                  ...
                  <span className="font-bold text-gray-900 text-sm md:text-base">박*영 고객님 (신용카드현금화)</span>
                </div>
                <div className="flex items-center">
                  <div className="flex text-yellow-400">
                    <span className="text-lg md:text-xl">⭐</span>
              ...
              <p className="text-gray-700 text-sm md:text-base">"신용카드현금화 절차가 복잡할 줄 알았는데 공룡페이는 생각보다 간편하고 안전하게 처리해주셔서 감사합니다. 믿고 맡길 수 있겠어요."</p>
            </div>
          </div>
      ...
      <section className="py-12 md:py-20 bg-green-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl text-green-100 mb-8 max-w-4xl mx-auto leading-relaxed">소액결제현금화, 정보이용료현금화, 신용카드현금화, 상품권현금화 등 24시간 언제나 신속하고 친절하게 상담해드립니다. 궁금한 점이 있다면 망설이지 말고 공룡페이에 연락주세요!</p>
