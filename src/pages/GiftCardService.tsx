...
const faqData = [
  ...
  { question: "24시간 거래 가능한가요?", answer: "네, 공룡페이는 365일 24시간 운영되므로 언제든지 상품권 현금화 상담 및 거래가 가능합니다." },
];
  ...
  return (
    <>
      ...
      <SEO 
        ...
        description="상품권 현금화 합리적인 시세로 매입! 문화상품권, 해피머니, 신세계상품권, 도서문화상품권 현금화. 24시간 5분 즉시 입금, 수수료 싼곳 공룡페이입니다."
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="bg-gradient-to-br from-orange-50 to-orange-100 py-12 md:py-20">
          <div className="container mx-auto px-4 text-center">
            <Breadcrumb items={[{ label: "공룡페이", path: "/" }, { label: "상품권 현금화" }]} />
        ...
        <div className="container mx-auto px-4 py-12 md:py-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div>
                  <p className="text-gray-700 text-lg leading-relaxed mb-6">
                    ...
                    에서는 다양한 종류의 상품권을 합리적인 지급률로 현금화해드리며,
          ...
          <section className="mb-16">
            ...
            <p className="text-center text-gray-600 mb-8">
              보유하신 상품권 외에 다른 결제 수단으로도 현금화가 가능합니다. 아래에서 확인해보세요.
            </p>
            ...
            >
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm mb-3">
                  휴대폰 소액결제 한도로 3분 이내 즉시 현금화
                </p>
                <span className="text-green-600 font-semibold text-sm hover:text-green-700 transition-colors">
                  소액결제현금화 방법 보기 →
                </span>
              </div>
            </Link>
