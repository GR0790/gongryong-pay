  ...
  return (
    <>
      ...
      <SEO 
        ...
        description="신용카드 현금화, 카드깡 절대 아님! 합법적인 결제 한도 현금화 서비스. 수수료 싼곳, 지급률 최대 88%. 삼성/신한/현대 등 전 카드사 3분 즉시 입금 공룡페이."
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="bg-gradient-to-br from-purple-50 to-purple-100 py-12 md:py-20">
          <div className="container mx-auto px-4 text-center">
            <Breadcrumb items={[{ label: "공룡페이", path: "/" }, { label: "신용카드 현금화" }]} />
        ...
        <div className="container mx-auto px-4 py-12 md:py-16">
          ...
          <section className="mb-16">
            ...
            <p className="text-center text-gray-600 mb-8">
              신용카드 한도 외에도 다양한 현금화 방법이 있습니다. 상황에 맞는 서비스를 골라보세요.
            </p>
