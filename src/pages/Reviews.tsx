...
const Reviews: React.FC = () => {
  const reviews = [
    {
      ...
      rating: 5,
      content:
        "정말 급했는데 3분도 안되서 입금됐어요! 상담도 친절하시고 소액결제 현금화 정말 만족스러웠습니다. 공룡페이 덕분에 잘 해결했어요. 다음에도 꼭 이용할게요!",
      amount: "50만원",
    },
    {
      id: 2,
  ...
  return (
    <>
      <SEO
        title="고객 후기 1,247건 확인하기"
        description="공룡페이 실제 고객 후기 1,247건, 평균 평점 4.8점. 소액결제·정보이용료·신용카드·상품권 현금화 서비스 후기를 확인하세요."
        keywords="공룡페이 후기, 소액결제현금화 후기, 정보이용료현금화 후기, 신용카드현금화 후기, 상품권현금화 후기"
      />
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="bg-gradient-to-br from-green-50 to-green-100 py-12 md:py-20">
          <div className="container mx-auto px-4 text-center">
            <Breadcrumb items={[{ label: "공룡페이", path: "/" }, { label: "고객 후기" }]} />
