      ...
      <section className="bg-gradient-to-br from-yellow-50 to-yellow-100 py-12 md:py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            소액결제, 정보이용료, 신용카드, 상품권, 콘텐츠이용료 현금화 등 모든<br />
            서비스 관련 문의를 24시간 365일 카카오톡으로 신속하고 친절하게 상담해드립니다.<br />
            급한 비상금이 필요하신가요? 지금 바로 카카오톡으로 문의해 보세요!
          </p>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 text-center border border-yellow-200">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">💬 카카오톡 즉시상담</h2>
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              가장 편리하고 빠른 상담 방법입니다.<br />
              24시간 365일 전문 상담원이 대기중이며,<br />
        ...
        <div className="mt-16 bg-white rounded-2xl shadow-lg p-6 md:p-8">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8 text-center">공룡페이 상담 안내</h2>
          ...
          <div className="mt-8 text-center">
            <p className="text-lg text-gray-700 mb-4">
              <Link to="/faq" className="text-yellow-600 hover:text-yellow-700 font-semibold">자주 묻는 질문 (FAQ) 페이지</Link>에서 미리 궁금증을 해결해보세요.
            </p>
          </div>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-2xl p-8 md:p-12 text-white">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">🦕 급한 비상금, 지금 바로 해결하세요!</h2>
            <p className="text-lg md:text-xl mb-8 opacity-90">
              소액결제, 정보이용료, 신용카드, 상품권 현금화를 전문으로 하는 공룡페이.<br />
              카카오톡으로 안전하고 신속한 상담을 받아보세요!
            </p>
